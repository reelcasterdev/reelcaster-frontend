        ...
        <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 pt-16 lg:pt-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-1">Your fishing history and statistics</p>
            </div>
          ...
          {showFilters && (
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 mb-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-medium text-gray-400 mb-2">Species</label>
                  <select
                    value={filterSpecies}
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-400 mb-2">Outcome</label>
                  <select
                    value={filterOutcome}
